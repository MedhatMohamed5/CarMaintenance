...
const Map<String, String> kStringsEn = {
  ...
  'entryCompleted': 'Completed service',
  'entryBooking': 'Upcoming booking',
  'entryCompletedHint': 'Work already carried out — logged to history',
  'entryBookingHint':
      'An appointment ahead. Nothing is logged to history until you confirm '
      'it was done.',
  'appointmentDate': 'Appointment date',
  'completionDate': 'Completion date',
  'statusBooked': 'Booked',
  'statusMissed': 'Appointment passed',
  'markCompleted': 'Confirm service done',
  'markCompletedTitle': 'Confirm this service',
  'markCompletedHint':
      'This adds the service to your history, resets the parts on it and stops '
      'its reminders.',
  'noBookings': 'No booked services',
  'bookingToday': 'Today',
  'bookingTomorrow': 'Tomorrow',
  'bookingInDays': 'In {n} days',
  'bookingDaysLate': '{n} days past the appointment',
  'expectedOdometer': 'Expected odometer',
  ...
  'notifBookingTomorrowTitle': 'Service booking tomorrow',
  'notifBookingTodayTitle': 'Service booking today',
  ...
  'authPasswordsDontMatch': 'The two passwords do not match',
  'authPasswordTooShort': 'Use at least {n} characters',
  'authEmailInvalid': 'Enter a valid email address',
  'authFixFields': 'Check the highlighted fields',
  'authName': 'Name',
  ...
  'invoiceAttachment': 'Invoice / receipt',
  'invoiceNone': 'No invoice attached',
  'invoiceDownload': 'Download',
  'invoiceTooLarge': '{n} file(s) were too large to attach',
  'invoiceLimit': 'Up to {n} invoices per entry',
  'scanInvoice': 'Photograph',
